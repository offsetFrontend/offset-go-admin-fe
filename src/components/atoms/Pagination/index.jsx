...
const Pagination = ({ currPage, onNext, onPrev }) => {
  return (
    <div className="flex justify-center mt-8 relative px-12">
      <Button
        ...
        varient={"primary"}
        className={
          "text-blue-800 border-[1px] border-blue-800 px-7 bg-blue-300 text-[9px] py-1.5 font-bold w-44 rounded-md h-7"
        }
      >
        Previous Page
      </Button>
      ...
      <Button
        ...
        varient={"primary"}
        className={
          "text-white px-7 ml-4 text-[9px] py-1.5 font-bold w-44 rounded-md h-7"
        }
      >
        Next Page
      </Button>
