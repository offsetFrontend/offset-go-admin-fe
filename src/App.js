...
import RetirementDetails from "./pages/RetirementDetails.jsx";
import TransferDetails from "./pages/TransferDetails.jsx";
function App() {
  ...
  const router = createBrowserRouter([
    { path: "/login", element: authUser ? <Navigate to="/" /> : <Login /> },
    {
      ...
      children: [
        ...
        {path: "/retirementdetails/:id", element: <RetirementDetails/>},
        { path: "/transferdetails/:id", element: <TransferDetails/>},
      ],
    },
  ]);
  return (
